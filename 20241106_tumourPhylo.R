...
mybed_muts_tumour = twins_dt[mut_ID %in% muts_tumour, c('Chrom', 'Pos', 'Ref', 'Alt')]
mybed_muts_putgerm = twins_dt[mut_ID %in% muts_normal, c('Chrom', 'Pos', 'Ref', 'Alt')]
